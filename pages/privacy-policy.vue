<template>
  <div class="page">
    <h2>プライバシーポリシー 個人情報について</h2>
    <p>当サイトでは、メールアドレス・パスワードのような個人情報は一切収集していません。</p>
    ...
    <p>
      ...
      >また、更なる記事の閲覧性向上を目的とした、「GoogleAPIs Analytics Reporting API」から「Googleアナリティクス」のPV数を取得し、ランキングとしてサイトに表示するといったことも行っております。</span>
    </p>
    <h2>免責事項</h2>
    <p>
