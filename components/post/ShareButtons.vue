...
export default {
  ...
  data() {
    return {
      url: `https://manji.fun${this.$route.path}`,
      twitter_url: "https://twitter.com/intent/tweet?url={0}&text={1}&hashtags=manjifun",
  ...
  methods: {
    ...
    twitterUrl() {
      return this.formatByArr(this.twitter_url, this.url, this.post.fields.title);
    },
    lineUrl() {
    ...
    hatebuUrl() {
      return this.formatByArr(this.hatebu_url, this.url, this.post.fields.title);
    },
    pocketUrl() {
